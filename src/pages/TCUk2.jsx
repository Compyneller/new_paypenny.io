    ...
    <>
      <div className="w-100 bg-light ">
        ...
        <div className="container p-5">
          ...
          <p>
            This User Agreement (“Agreement”) is effective as of July 2022 and
            was most recently updated in August 2022. It describes the terms by
            which you will be bound when you use the services accessible on our
            mobile applications through Google Play store and Apple Store
            “Service”. Paypenny requests you to not use the Service if you do
            not agree to abide by these terms. By using the Service you agree to
            all of the terms contained in this User Agreement. As used
            throughout this Agreement, the terms “Paypenny”, “we”, “us”, and
            “our” refer to Paypenny United Kingdom, Inc., a Trackon Canada
            Private Limited venture, together with its employees, directors,
            successors, and assignees. The terms “you” and “your” refer to users
            of the Service, whether as Senders or Recipients.
          </p>
          <h5 style={{ fontWeight: "bold" }}>1- THE SERVICE</h5>
          <p>
            The Service allows users to send international money transfers from
            the United Kingdom to India served by Trackon Canada Private Limited
            T/A Paypenny. A “Sender'' uses the Service to send money and a
            “Recipient” receives money through the Service. A “Transaction”
            refers to a command to send money through the Service via Paypenny
            Wallet. The “Transaction Amount” is the amount in Pound that the
            Sender provides to Paypenny for transmittal to the Recipient. The
          ...
          <p>
            ...
            users. It lets you send money to the desired account in India from
            the United Kingdom depending upon the current rates applicable at
            that time.
          </p>
          <p>
            <b>3.2.Payment</b>
          ...
          <p>
            By entering your Payment mode details in our system to feature money
            in the wallet, you authorize us automatically to debit that quantity
            and reflect it within the wallet for further transaction. This
            authorization shall apply to any Payment Mode entered into your
            payment profile.
          </p>
          <p>
          ...
          <p>
            You can cancel this authorization at any time by closing your
            Paypenny account. For more information on cancellation, you can
          ...
          <p>
            We work with local banks and other third party outlets (each, a
            “Service Provider”) to form funds available to Recipients in India.
            As a Sender, you’re appointing your Recipient as your agent for the
            aim of receiving funds transmitted through the Service
          </p>
          <p>
          ...
          <p>
            ...
            while transferring the amount. Failing which we may stop the
          ...
          <p>
            ...
            controlled substances; or to send money to a Recipient that has
            ...
            recommend you employ the Service to send money to friends and family
            and, therefore, you ought to not use the Service to send money to
            strangers.
          </p>
          <p>
            <b>6.4. No Changes</b>
          ...
          <p>
            Paypenny processes transactions to India pursuant to the Rupee
            Drawing Arrangements (“RDA”), as established by the Reserve Bank of
            India. You understand that use of the Service for commercial
            purposes or contributions to charitable organizations is prohibited.
          </p>
          ...
          <p>
            ...
            <br />
            You consent and authorize us to make any inquiries, to you or to
            others, which are necessary to validate the information that you
            provide to us.
          </p>
          ...
          <p>
            ...
            Limited and its trade name Paypenny. You agree not to display, use,
            copy, or modify Paypenny Intellectual Property in any manner.
          </p>
          ...
          <p>
            Disputes with Paypenny:If a dispute arises between you and Paypenny,
            our goal is to learn about and address your concerns. If we are
            unable to address your concerns to your satisfaction, we will seek
            to provide you with a neutral and cost-effective means of resolving
            the dispute quickly.
          </p>
          <p>
          ...
          <p>
            Arbitration:Any dispute regarding this Agreement, including the
            validity, existence, binding effect, interpretation, performance,
            breach or termination, and including tort claims, may be referred to
            and finally determined, to the exclusion of the courts, by a single
            arbitrator.
          </p>
          <h5>14- COMMUNICATIONS</h5>
          <p>
            You acknowledge and consent that this User Agreement shall be
            entered into electronically.Communications may be provided to you at
            the telephone number(s) that you provide us with through (i) the use
            of autodialed or prerecorded message calls or (ii) text messages,
            subject to the requirements. The hardware and software requirements
            for access to and retention of the Communications associated with
            the Service include a personal computer or other device which is
          ...
          <p>
            ...
            urge you to think carefully before sending money to anyone that you
            do not know well.
          </p>
          <h5>17- LANGUAGE</h5>
          <p>
